...
import { n as import_eventemitter3 } from "./eventemitter3-Fg96zH73.js";
...
var AttributorStore$1 = AttributorStore, _ShadowBlot = class _ShadowBlot {
...
var InlineBlot$1 = _InlineBlot, _BlockBlot = class _BlockBlot extends ParentBlot$1 {
	static create(value) {
		return super.create(value);
	}
	static formats(domNode, scroll) {
...
var BlockBlot$1 = _BlockBlot, _ContainerBlot = class _ContainerBlot extends ParentBlot$1 {
	checkMerge() {
...
var EmbedBlot$1 = EmbedBlot, OBSERVER_CONFIG = {
	attributes: !0,
	characterData: !0,
...
var ScrollBlot$1 = _ScrollBlot, _TextBlot = class _TextBlot extends LeafBlot$1 {
	static create(value) {
...
var ReactQuill = class extends import_react.Component {
	...
	*/
	...
	isEqualValue(value, nextValue) {
		if (this.isDelta(value) && this.isDelta(nextValue)) return isEqual$1(value.ops, nextValue.ops);
		else return isEqual$1(value, nextValue);
	}
...
//#endregion
export { quill_default as Quill, index_default as default };
