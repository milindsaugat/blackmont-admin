    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      {videoSource === 'upload' ? (
        <div style={{ border: '1px dashed var(--gold-30)', padding: 32, borderRadius: 12, textAlign: 'center', background: 'rgba(212,175,55,0.02)' }}>
          ...
          {videoFile && !error && <div style={{ marginTop: 24 }}><video src={videoFile} controls style={{ width: '100%', maxWidth: 400, borderRadius: 8, border: '1px solid var(--border-default)' }} /></div>}
        </div>
      ) : (
        <div>
...
export default function IRHeroEditor({ data, onChange }) {
